...
import com.ncvas.njcc.service.NjccBankCardService;
...
public class BankCallBackListener implements MessageListener {
    ...
    @Autowired
    private NjccBankCardService bankCardService;
    @Override
    public void onMessage(Message m) {
        try {
            ...
            bankCardService.processPayPlatformCallBack(depositOrderNo,status,depositAmount);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    }
